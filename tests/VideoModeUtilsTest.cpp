...
int main() {
	...
	assert(nSCGL::AppendVideoMode(modes, 1920, 1080, 32, false));
	assert(!nSCGL::AppendVideoMode(modes, 1920, 1080, 32, false));
	assert(nSCGL::AppendVideoMode(modes, 1920, 1080, 32, true));
	assert(nSCGL::AppendVideoMode(modes, 3200, 1800, 32, false));
	assert(modes.size() == 3);
