...
int main() {
	...
	assert(nSCGL::AppendVideoMode(modes, 1920, 1080, 32, false, true, true));
	assert(!nSCGL::AppendVideoMode(modes, 1920, 1080, 32, false, true, true));
	assert(nSCGL::AppendVideoMode(modes, 1920, 1080, 32, true, true, true));
	assert(nSCGL::AppendVideoMode(modes, 3200, 1800, 32, false, false, false));
	assert(modes.size() == 3);
