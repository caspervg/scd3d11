...
namespace
{
	...
	SCD3D11FrameCallback g_callback{};
	void* g_userData{};
...
extern "C" BOOL __stdcall SCD3D11RegisterFrameCallback(
	SCD3D11FrameCallback callback, void* userData)
{
	if (callback == nullptr) return FALSE;
	nSCD3D11::Log(nSCD3D11::LogCategory::Grid, "SCD3D11RegisterFrameCallback(callback=%p, userData=%p)",
...
extern "C" BOOL __stdcall SCD3D11UnregisterFrameCallback(
	SCD3D11FrameCallback callback, void* userData)
{
